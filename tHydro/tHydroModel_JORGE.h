...
/**************************************************************************/
  void	 SoilGDF(tInputFile &);
  void	 SoilResamp(tResample *);

// Set/Get Functions for the soil grids
  void	 setKsat(double);
  void	 setThs(double);
  void	 setThr(double);
  void	 setPoreInd(double);
  void	 setPsib(double);
  void	 setF(double);
  void	 setAr(double);
  void	 setUAr(double);
  ...
  void	 setCond(double);
  void	 setCapac(double);

  double  getKsat(int);
  double  getThs(int);
  double  getThr(int);
  double  getPoreInd(int);
  double  getPsib(int);
  double  getF(int);
  double  getAr(int);
  double  getUAr(int);
  double  getPorosity(int);
  double  getCond(int);
  double  getCapac(int);

  char   scfile[kMaxNameSize];
/**************************************************************************/
...
private: 
  ...
  int stdgrid_opt; //JorgeGiuseppe2015
...
/**************************************************************************/
  ...
  int soiloptG, nParmSC;
  int SCgridgmt;
  double SCgridlat, SCgridlong;
